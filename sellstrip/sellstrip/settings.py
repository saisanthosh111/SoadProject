"""
Django settings for sellstrip project.
...
SECRET_KEY = '#2b4izib-tw#0@vey$%u%4q#!86!3_*4fd+u$s&6po&=04kch8'
...
WSGI_APPLICATION = 'sellstrip.wsgi.application'
